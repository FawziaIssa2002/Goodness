...
//     useEffect(() => {
//         setLoading(true); 
//         Axios.get(`/show_users`).then((data) =>{
//             // get `${USER}/${id}`
//             setName(data.data.name);
//             setEmail(data.data.email);
//             setPassword(data.data.password);
//             setRole(data.data.role_id);
//             setCenter_id(data.data.center_id);
//             // setJob(data.data.job);
//             setNum_family(data.data.num_family);
//             setBase_pay(data.data.base_pay);
//             setBirthday(data.data.birthday);
//             setState(data.data.state);
//             // setProject_name(data.data.project_name);
//         setLoading(false);
//         })
...
//      className="mb-3" 
//      controlId="exampleForm.ControlInput2">
//         <Form.Label>رقم الركز:</Form.Label>
//         <Form.Control
//          type="text" 
//          name="center_id"
//         value={center_id}
...
//   } , []);
    ...
    useEffect(() => {
        setLoading(true); 
            // show_users
        const res = Axios.get(`/info/${id}`).then((data) =>{
            console.log(data);
            // get ${USER}/${id}
            // show_users
            ...
            setCenter_id(data.data.data.center_id);
            setNum_family(data.data.data.num_family);
            setBase_pay(data.data.data.base_pay);
            setBirthday(data.data.data.birthday);
